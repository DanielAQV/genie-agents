        ...
        "parameters": {"type": "object", "properties": {
            _문지기_키: {
                ...
                "description": (
                    ...
                    "목소리를 보내 달라고 한다, (다) 방금 알려준 것을 적어 둬야 한다. "
                    "그냥 말로 답하면 되는 자리는 전부 '아니'. "
                    # ★ 예전엔 (다)가 "무언가를 기록해 둬야 한다" 였다. 그 말이
                    #   너무 넓어서 사진 얘기 중에 principle_record 가 네 번
                    #   골라졌고, 같은 원칙이 네 번 확정으로 들어갔다
                    #   (2026-09-02). 원칙 세우는 것은 이 턴에 답하려고 하는
                    #   일이 아니라 되짚는 일이라, 여기서 고를 일이 아니다.
                    "원칙을 세우는 것은 지금 답하는 일이 아니니 '아니'.")}},
            "required": [_문지기_키]}}}
